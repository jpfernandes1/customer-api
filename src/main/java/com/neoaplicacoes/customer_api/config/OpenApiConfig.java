package com.neoaplicacoes.customer_api.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("Customer API").version("1.0").description("API para gestão de clientes"))
    ...
    public OperationCustomizer operationCustomizer() {
        return (Operation operation, HandlerMethod handlerMethod) -> {
            ...
            if (operation.getResponses() == null || operation.getResponses().isEmpty()) {
                ...
                String method = operation.getOperationId() != null ? operation.getOperationId().toUpperCase() : "";
