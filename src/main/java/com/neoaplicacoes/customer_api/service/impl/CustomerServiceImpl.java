 ...
 * Provides CRUD operations, filtering, and pagination using CustomerMapper (MapStruct).
 */
@Service
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerResponseDTO> getByCityAndNeighborhood(String city, String neighborhood) {
        List<Customer> list = customerRepository.findByAddressCityIgnoreCaseAndAddressNeighborhoodIgnoreCase(city, neighborhood);
        return customerMapper.toDtoList(list);
    }
    ...
    public Page<CustomerResponseDTO> getByCityPaged(String city, Pageable pageable) {
        return customerRepository.findByAddressCityIgnoreCase(city, pageable)
                .map(customerMapper::toDto);
    }

    @Override
    public Page<CustomerResponseDTO> getByStatePaged(String state, Pageable pageable) {
        return customerRepository.findByAddressStateIgnoreCase(state, pageable)
                .map(customerMapper::toDto);
    }

    @Override
    public Page<CustomerResponseDTO> getByCityAndNeighborhoodPaged(String city, String neighborhood, Pageable pageable) {
        Page<Customer> page = customerRepository.findByAddressCityIgnoreCaseAndAddressNeighborhoodIgnoreCase(city, neighborhood, pageable);
