...
public interface AddressRepository extends JpaRepository<Address, Long> {
    ...
    Page<Address> findByCityIgnoreCaseAndNeighborhoodIgnoreCase(String city, String neighborhood, Pageable pageable);
    ...
    Page<Address> findByCityIgnoreCaseAndStreetContainingIgnoreCase(String city, String street, Pageable pageable);
}
