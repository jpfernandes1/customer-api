package com.neoaplicacoes.customerapi.exception;

import com.neoaplicacoes.customerapi.model.dto.response.ErrorResponseDTO;
...
/**
 * Global exception handler for the application. Handles common exceptions and maps them to proper
 * HTTP responses.
 */
...
public class GlobalExceptionHandler {
  ...
  private ResponseEntity<ErrorResponseDTO> buildResponse(
    ...
    ErrorResponseDTO body =
        new ErrorResponseDTO(LocalDateTime.now(), status.value(), message, errors);
  ...
  public ResponseEntity<ErrorResponseDTO> handleConstraint(DataIntegrityViolationException ex) {
    ...
    String message =
        ex.getRootCause() != null ? ex.getRootCause().getMessage() : "Data integrity violation";
