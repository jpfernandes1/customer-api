...
public class UserController {
  ...
  @Operation(
      ...
      description = "Allows a new user to create their own account")
  ...
  @Operation(
      summary = "Partial update of user admin fields",
      description = "Update role or active status (ADMIN only)")
  @PreAuthorize("hasRole('ADMIN')")
  @PatchMapping("/{id}/admin")
  public ResponseEntity<UserResponseDTO> updateAdmin(
      @PathVariable Long id, @Valid @RequestBody UserAdminRequestDTO dto) {
  ...
  @Operation(
      summary = "Find users by email (unpaginated)",
