...
class CustomerControllerTest {
    ...
    private CustomerRequestDTO sampleRequest() {
        ...
        return new CustomerRequestDTO(
                "John", "john@doe.com", "12345678901",
                "11999999999", LocalDate.of(1990, 1, 1), addr
        );
    }

    private CustomerResponseDTO sampleResponse() {
        return new CustomerResponseDTO(
                1L, "John", "john@doe.com", "12345678901",
                "11999999999", LocalDate.of(1990, 1, 1), 34,
    ...
    void getById_notFound() throws Exception {
        when(service.getById(99L)).thenThrow(new EntityNotFoundException("Customer not found with id 99"));
    ...
    void getByCpfPaged() throws Exception {
        when(service.getByCpfPaged(eq("123"), any()))
                .thenReturn(new PageImpl<>(List.of(sampleResponse())));
        mvc.perform(get("/api/customers/search/by-cpf?cpf=123"))
                .andExpect(status().isOk());
    }
    ...
    void getByCityPaged() throws Exception {
        when(service.getByCityPaged(eq("São Paulo"), any()))
                .thenReturn(new PageImpl<>(List.of(sampleResponse())));
        mvc.perform(get("/api/customers/search/by-city?city=São Paulo"))
                .andExpect(status().isOk());
    }
    ...
    void getByStatePaged() throws Exception {
        when(service.getByStatePaged(eq("SP"), any()))
                .thenReturn(new PageImpl<>(List.of(sampleResponse())));
        mvc.perform(get("/api/customers/search/by-state?state=SP"))
                .andExpect(status().isOk());
    }
    ...
    void getByCityAndNeighborhoodPaged() throws Exception {
        when(service.getByCityAndNeighborhoodPaged(eq("São Paulo"), eq("Centro"), any()))
                .thenReturn(new PageImpl<>(List.of(sampleResponse())));
        mvc.perform(get("/api/customers/search/by-city-and-neighborhood?city=São Paulo&neighborhood=Centro"))
                .andExpect(status().isOk());
    }
    ...
    void getByName() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-name?name=john"))
                .andExpect(status().isOk());
    }
    ...
    void getByEmail() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-email?email=john@doe.com"))
                .andExpect(status().isOk());
    }
    ...
    void getByCpf() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-cpf?cpf=12345678901"))
                .andExpect(status().isOk());
    }
    ...
    void getByCity() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-city?city=São Paulo"))
                .andExpect(status().isOk());
    }
    ...
    void getByState() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-state?state=SP"))
                .andExpect(status().isOk());
    }
    ...
    void getByCityAndNeighborhood() throws Exception {
        ...
        mvc.perform(get("/api/customers/all/by-city-and-neighborhood?city=São Paulo&neighborhood=Centro"))
                .andExpect(status().isOk());
    }
