...
import com.neoaplicacoes.customerapi.service.AddressService;
...
class AddressControllerTest {
  ...
  private AddressRequestDTO sampleRequest() {
    return new AddressRequestDTO(
        "12345678", "100", "Apt 10", "Main St", "Centro", "São Paulo", "SP");
  }
  ...
  void deleteAsAdmin() throws Exception {
    mvc.perform(delete("/api/addresses/1").accept(MediaType.APPLICATION_JSON))
  ...
  void getById() throws Exception {
    ...
    mvc.perform(get("/api/addresses/1").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  void getById_notFound() throws Exception {
    ...
    mvc.perform(get("/api/addresses/99").accept(MediaType.APPLICATION_JSON))
  ...
  void getAllPaged() throws Exception {
    ...
    mvc.perform(get("/api/addresses?page=0&size=10").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  void getByCityPaged() throws Exception {
    when(service.getByCityPaged(anyString(), any(Pageable.class)))
        .thenReturn(pageOf(sampleResponse()));

    mvc.perform(
            get("/api/addresses/search/by-city?city=São Paulo").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByStatePaged() throws Exception {
    when(service.getByStatePaged(anyString(), any(Pageable.class)))
        .thenReturn(pageOf(sampleResponse()));

    mvc.perform(get("/api/addresses/search/by-state?state=SP").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByNeighborhoodPaged() throws Exception {
    when(service.getByNeighborhoodPaged(anyString(), any(Pageable.class)))
        .thenReturn(pageOf(sampleResponse()));

    mvc.perform(
            get("/api/addresses/search/by-neighborhood?neighborhood=Centro")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByCityAndNeighborhoodPaged() throws Exception {
    ...
    mvc.perform(
            get("/api/addresses/search/by-city-and-neighborhood?city=São Paulo&neighborhood=Centro")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByStreetPaged() throws Exception {
    when(service.getByStreetPaged(anyString(), any(Pageable.class)))
        .thenReturn(pageOf(sampleResponse()));

    mvc.perform(
            get("/api/addresses/search/by-street?street=Main").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByCityAndStreetPaged() throws Exception {
    ...
    mvc.perform(
            get("/api/addresses/search/by-city-and-street?city=São Paulo&street=Main")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getAll() throws Exception {
    ...
    mvc.perform(get("/api/addresses/all").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  void getByCity() throws Exception {
    ...
    mvc.perform(get("/api/addresses/all/by-city?city=São Paulo").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByState() throws Exception {
    ...
    mvc.perform(get("/api/addresses/all/by-state?state=SP").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByNeighborhood() throws Exception {
    ...
    mvc.perform(
            get("/api/addresses/all/by-neighborhood?neighborhood=Centro")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByCityAndNeighborhood() throws Exception {
    when(service.getByCityAndNeighborhood(anyString(), anyString()))
        .thenReturn(List.of(sampleResponse()));

    mvc.perform(
            get("/api/addresses/all/by-city-and-neighborhood?city=São Paulo&neighborhood=Centro")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByStreet() throws Exception {
    ...
    mvc.perform(get("/api/addresses/all/by-street?street=Main").accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
  ...
  void getByCityAndStreet() throws Exception {
    when(service.getByCityAndStreet(anyString(), anyString()))
        .thenReturn(List.of(sampleResponse()));

    mvc.perform(
            get("/api/addresses/all/by-city-and-street?city=São Paulo&street=Main")
                .accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON));
  }
